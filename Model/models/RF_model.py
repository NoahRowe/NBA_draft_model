...
# START THE FUNCTION
##################################################################################################
def simulation(scaler_type, n_clusters, distance_metric, n_players, nba_scaler_type, OS_size, US_size, OS_val, US_val, count):
...
#             print("{}/{} completed!".format(i+1, len(scaledDraft)))
    ...
    np.save("./Results/RF_results/"+filename, results)
